...
export default function SocialIcons() {
  return (
    <div className="absolute top-5 left-5 flex space-x-5 z-50">
      <Link href="https://github.com/KarthikPatralapati01?tab=repositories" target="_blank" rel="noopener noreferrer">
      ...
      <Link href="https://leetcode.com/u/karthikpatralapati/" target="_blank" rel="noopener noreferrer">
